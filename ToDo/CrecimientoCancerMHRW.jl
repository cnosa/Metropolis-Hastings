...
# ╔═╡ e096cfe6-f1c6-4993-8625-ca9867a1e272
begin
	using LinearAlgebra
	using Plots
	using PlutoUI
...
# ╔═╡ 261eb8c7-2d32-458f-9039-badf938ec8bd
PlutoUI.TableOfContents(title="Crecimiento del Cancer", aside=true)

# ╔═╡ 268f7a5a-f8eb-44f1-a629-680f1d9460a4
md"""
# Función del algoritmo MHRW
"""

# ╔═╡ 236cea3e-1d9c-4817-aade-43881218b432
begin
...
# ╔═╡ f7f54f5b-8e16-4f60-917c-934e9478c89d
md"""
# Introducción


Consideremos el ejemplo siguiente donde tenemos datos del crecimiento de un tumor en ratones. Los datos son tomados (y mas información) se encuentran en: Modeling Cancer Growth with Differential Equations de Jue Wang, Department of Mathematics Union College, Schenectady NY 12308 USA.
"""

# ╔═╡ bda7b416-eb5e-43fc-9be7-0aebae932af4


# ╔═╡ 75f9d5bb-2cd3-46b5-844e-3d5b8f77d725
begin
#Datos
...
# ╔═╡ 2bb60d9a-b226-4a98-ae4d-343baec27fdd
md"""
# Ajuste polinómico
"""

# ╔═╡ b2686168-15c6-45c6-8dfb-552dd846fe78
md"""
## Polinomio Lineal
En el modelo asumimos que:


$V(t)\approx k+ mt$

y con esto queremos estimar $m$ y $k$.
"""

# ╔═╡ 9909ae52-9199-448a-8bb2-618c0d1485ef
begin
	...
	function energialinea(p) #log de la posterior
    	...
    	return log_likelihood*(10^(-4)) + log_priori*(10^(-5))
	end
...
# ╔═╡ 6079d629-f902-4f5c-bbf3-d29fa3cc45bb
begin
...
# ╔═╡ 12f4f316-b97b-497d-bc78-00178f930e7f
begin
...
# ╔═╡ eb1cb3b3-74da-4018-a190-ad0f8101a5bf
md"""
# Ecuación diferencial con condición inicial

Considere el modelo del crecimiento del tumor dado por la ecuación diferencial 

$V' = a V^{2/3}-b V,$

con $V(0)=V_0$ conocido. La variable $V$ representa una aproximación al volumen del tumor en el tiempo $t$. 	
"""

# ╔═╡ 5658c769-e070-4ac5-8c04-6411fd91e005
begin
...
# ╔═╡ ed071e1e-9e4d-4415-8fd1-742c660abcae
begin
	#Energía
...
# ╔═╡ cee2e9f7-7703-401f-a4c8-8297e056e851
begin
...
# ╔═╡ 1afbe86a-ab84-440d-b322-babd3ac4a7f1
begin
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "313d49b0b26c0426c33778033d8f523febceb4bc"
