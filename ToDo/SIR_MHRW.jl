...
# ╔═╡ 1eb4d750-cd06-11ee-25be-457dd5fcf480
begin
	#using DataFrames
...
# ╔═╡ a792f266-72bc-439a-a03a-072c205e2664
PlutoUI.TableOfContents(title="Modelo SIR usando MHRW", aside=true)

# ╔═╡ a371d71e-d490-4f2c-9406-5ae603c4ceed
md"""
# Modelo SIR
"""

# ╔═╡ cd7497dd-a45b-4eac-908d-609a48ca52b4
md"""
Problema. Estimar el número básico reproductivo $\mathcal{R}_0$ de la gripe española en San Francisco en el año 1918.
"""

# ╔═╡ d2c284cc-f60d-4343-ab14-fb1ec5a4a453
begin
	#data_frame = DataFrame(load("pandemic_infuenza_SF_1918.xls", "Sheet1"))
...
# ╔═╡ 8ae4e8b9-e571-408d-8c3e-4889bd94154a
...
# ╔═╡ 051b9032-d2dc-4b1d-8924-b373741f0288
md"""
Modelo matemático de la influenza En este cuaderno se modela el comportamiento de la gripe española en San Francisco de 1918 a 1919.


donde $N=S+I+R$ y $\dot{N}=0$.  Los parámetros  y  son conocidos. Con el modelo anteriormente mencionado se quiere hallar el número de reproducción  y los parámetros 
 y .
"""

# ╔═╡ 5365cd0a-79dc-4adf-8caf-a18bac29514f
begin
	#Valores inciales
	mu = 1.0 / (75.0 * 365.0)
	xi = 10^(-5)
...
# ╔═╡ 8f19f359-f7b9-4697-8a04-c837b7237920
begin
	function rhs(t,x,p)
	    # Parámetros
	    beta = p[1]/100
...
# ╔═╡ 7fa1084d-2132-4429-9d4b-e0840d36adba
begin
	par = [45,99.985,0.015,0.00,8]
	Tpar, SIRpar = sol_num(par)
	p1 = plot(Tpar,SIRpar[1,:],label="S")
	p1 = plot!(Tpar,SIRpar[2,:],label="I")
	p1 = plot!(Tpar,SIRpar[3,:],label="R")
...
# ╔═╡ a0ed3fc1-5d98-4047-abb8-c143b4afa11f
begin
	function energy(p)
	    # Parámetros
	    mu = meanglm(p)
...
# ╔═╡ 6097af9d-43a2-49dc-a600-da07a9ba6e66
begin
	# Número de iteraciones
	iterations = 10000
	# Punto inicial 
	global samplesSIR = ones(5,1)
	global probabilitiesSIR = [exp(energy(samplesSIR[:,end]))] # energía
	
	global Alpha = [0] # tasa de aceptación
...
# ╔═╡ 5ff6e4f3-91e0-4f7b-b9cb-4a380a2d5857
begin
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "b9a97f0a5758b643efbd2efa61617daf74b76a3b"
